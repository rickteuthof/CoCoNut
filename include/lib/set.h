...
inline void ccn_set_free(CCNset_t *set) {
...
CCNset_t *ccn_set_intersect(CCNset_t *a, CCNset_t *b);

/* Returns a new set that is the union of a and b. */
CCNset_t *ccn_set_union(CCNset_t *a, CCNset_t *b);

/* Return a new set that is the difference (a-b) of a and b. */
CCNset_t *ccn_set_difference(CCNset_t *a, CCNset_t *b);
